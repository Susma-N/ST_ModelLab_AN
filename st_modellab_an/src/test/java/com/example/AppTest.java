...
public class AppTest {
    ...
    public void navigate() throws IOException {
        ...
        fs = new FileInputStream("C:\\Users\\susma\\OneDrive\\Desktop\\dbankdemo.xlsx");
    ...
    public void testCase2() throws InterruptedException {
        ...
        search.sendKeys(Keys.ENTER);
        Thread.sleep(2000);
        driver.findElement(By.xpath("/html/body/div[5]/div[2]/div/div[1]/div[3]/div[2]/div[1]/div[2]/div[2]/ul/li[4]/a/div")).click();
        Thread.sleep(2000);
